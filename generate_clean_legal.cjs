...
const privacyContent = `
    <div class="content-wrap" style="padding: 100px 20px 80px; max-width: 800px; margin: 0 auto; color: var(--c-text); position: relative; z-index: 10; background: rgba(0,0,0,0.4); backdrop-filter: blur(8px); border-radius: 20px; border: 1px solid rgba(255,255,255,0.05); margin-top: 40px;">
        ...
        <div class="legal-text" style="font-family: var(--font-sans); line-height: 1.8; opacity: 0.85; font-size: 1.05rem;">
            ...
            <p style="margin-bottom: 25px;">Crestiva requires a 25% advance payment for applicable website plans/services. Razorpay is intended to be used as our payment processor. Currently, our integration uses Razorpay TEST MODE for development and testing. Live payment processing will be enabled after our production backend is implemented. When live payments are enabled, Razorpay will process payment transactions through its secure infrastructure. Crestiva does not store sensitive payment credentials such as complete card numbers, CVVs, UPI PINs, or banking passwords.</p>
            
            <h2 style="font-family: var(--font-serif); font-size: 2rem; color: var(--c-highlight); margin: 40px 0 20px;">6. Third-Party Services</h2>
            <p style="margin-bottom: 25px;">Our website uses third-party services like Firebase and Supabase for database storage and authentication, and Razorpay for payment processing (currently in test mode). These services have their own privacy policies governing their data handling practices.</p>

            <h2 style="font-family: var(--font-serif); font-size: 2rem; color: var(--c-highlight); margin: 40px 0 20px;">7. Cookies and Tracking</h2>
            <p style="margin-bottom: 25px;">We may use essential cookies to maintain your session state. We do not currently use invasive third-party tracking or advertising cookies.</p>
            ...
            <p style="margin-bottom: 25px;">We use standard browser local storage and session data to manage your login state and save custom quote configurations during your active session.</p>

            <h2 style="font-family: var(--font-serif); font-size: 2rem; color: var(--c-highlight); margin: 40px 0 20px;">9. Data Sharing</h2>
            <p style="margin-bottom: 25px;">We do not sell, rent, or trade your personal data to any third parties for marketing purposes. Your data is strictly shared with the necessary third-party infrastructure (e.g., Firebase, Razorpay) required to deliver our service.</p>
...
const termsContent = `
    <div class="content-wrap" style="padding: 100px 20px 80px; max-width: 800px; margin: 0 auto; color: var(--c-text); position: relative; z-index: 10; background: rgba(0,0,0,0.4); backdrop-filter: blur(8px); border-radius: 20px; border: 1px solid rgba(255,255,255,0.05); margin-top: 40px;">
        ...
        <div class="legal-text" style="font-family: var(--font-sans); line-height: 1.8; opacity: 0.85; font-size: 1.05rem;">
            ...
            <p style="margin-bottom: 25px;">A 25% advance payment is required before work begins when a client purchases an applicable website plan or service. The remaining balance will be handled according to the specific project agreement. Currently, our system utilizes Razorpay in test mode for demonstration purposes. Official payment agreements will be coordinated securely.</p>
            ...
            <p style="margin-bottom: 25px;">Project-specific cancellation and refund terms will be governed by the applicable, finalized project agreement between Crestiva Web Studio and the client.</p>

            <h2 style="font-family: var(--font-serif); font-size: 2rem; color: var(--c-highlight); margin: 40px 0 20px;">8. Intellectual Property</h2>
            <p style="margin-bottom: 25px;">Upon full payment, ownership of the final client deliverables transfers according to the agreed project terms. However, this transfer does not include third-party assets, third-party libraries, open-source software, reusable internal tools, or pre-existing Crestiva code/components used to build the website. Unless a client agreement specifically states otherwise, Crestiva retains the right to showcase completed work in its portfolio and marketing materials.</p>
            
            <h2 style="font-family: var(--font-serif); font-size: 2rem; color: var(--c-highlight); margin: 40px 0 20px;">9. Third-Party Services</h2>
            <p style="margin-bottom: 25px;">Our projects may incorporate third-party services such as Firebase, Supabase, Razorpay, WhatsApp integrations, and various Email APIs. You agree to be bound by the terms and conditions of these third-party providers when utilizing their tools through our deliverables.</p>
