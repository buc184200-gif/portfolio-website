...
<head>
    ...
    <title>Crestiva Web Studio — Digital Atelier</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; cursor: default; }
        ...
        @media (max-width: 992px) {
            .calc-container { grid-template-columns: 1fr; padding: 2.5rem; }
        ...
        @media (max-width: 768px) {
            ...
            .nav { padding: 1.5rem 2rem; flex-direction: column; gap: 1.5rem; align-items: flex-start;}
            .footer { padding: 0 2rem 2rem; flex-direction: column; gap: 1rem; align-items: flex-start;}
            .content-wrap { padding: 4rem 1.5rem 6rem; gap: 6rem;}
...
<body>
    ...
    <div class="ui-layer">
        ...
        <div class="hero-section">
            <nav class="nav">
                <a href="/" class="nav-brand">Crestiva Web Studio</a>
                <div class="nav-links">
            ...
            <div class="hero">
                ...
                <div class="hero-actions">
                    <a href="#pricing" class="btn-main">View Packages <span class="btn-arrow">↓</span></a>
            ...
            <div class="footer">
                <div class="footer-left">
                    ...
                    © 2026 Crestiva Web Studio | Founders: Khushwant Singh & Sarthak Sengar
                </div>
        ...
        <div class="content-wrap">
            <section id="pricing" class="fade-in-section">
                <h2 class="section-heading">Website <em>Packages</em></h2>
                <div class="pricing-grid">
                    <div class="price-card">
                        <div class="plan-name">Starter</div>
                        <div class="plan-price"><span class="plan-price-old">₹12,999</span> ₹9,599</div>
                        <p class="plan-desc">Perfect for startups and local businesses.</p>
                        ...
                        <a href="https://wa.me/917037311050?text=I'm%20interested%20in%20the%20Starter%20Package" class="plan-btn" target="_blank">Select Starter</a>
                    </div>
                    
                    <div class="price-card featured">
                        <div class="plan-name">Growth</div>
                        <div class="plan-price"><span class="plan-price-old">₹24,999</span> ₹18,499</div>
                        <p class="plan-desc">Ideal for coaching institutes, gyms, clinics, and growing businesses.</p>
                        <ul class="plan-features">
                            <li>Up to 12 Pages</li>
                            <li>Custom UI/UX Design</li>
                            <li>Advanced Animations</li>
                            <li>Lead Generation Forms</li>
                            <li>Gallery & Testimonials</li>
                            <li>Advanced SEO Setup</li>
                            <li>Speed Optimization</li>
                            <li>Blog Integration</li>
                            <li>30 Days Support</li>
                        </ul>
                        <a href="https://wa.me/917037311050?text=I'm%20interested%20in%20the%20Growth%20Package" class="plan-btn" target="_blank" style="background: var(--c-accent); color: var(--c-bg);">Select Growth</a>
                    </div>

                    <div class="price-card">
                        <div class="plan-name">Elite</div>
                        <div class="plan-price"><span class="plan-price-old">₹59,999</span> ₹44,399+</div>
                        <p class="plan-desc">Built for businesses serious about scaling and unique identity.</p>
                        <ul class="plan-features">
                            <li>Fully Custom Website</li>
                            <li>Unlimited Pages</li>
                            <li>Premium WebGL Animations</li>
                        ...
                        <a href="https://wa.me/917037311050?text=I'm%20interested%20in%20the%20Elite%20Package" class="plan-btn" target="_blank">Select Elite</a>
                    </div>
                </div>
            </section>

            <section id="calculator" class="fade-in-section">
                <h2 class="section-heading">Project <em>Estimator</em></h2>
                <div class="calc-container">
                    <div class="calc-form">
                        <div class="form-group">
                            <label>Base Website Type</label>
                            <select id="calc-type" class="calc-input">
                                <option value="9599">Landing Page / Basic (~₹9,599)</option>
                                <option value="18499">Business / Growth (~₹18,499)</option>
                                <option value="44399">Custom / Elite (~₹44,399)</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label>Additional Pages (<span id="page-count-val">0</span> x ₹1,000)</label>
                            <input type="range" id="calc-pages" class="calc-range" min="0" max="20" value="0">
                        </div>
                        <div class="form-group">
                            <label>Premium Add-ons</label>
                            <div class="checkbox-grid">
                                <label class="checkbox-label"><input type="checkbox" class="calc-addon" value="5000"> Booking System</label>
                                <label class="checkbox-label"><input type="checkbox" class="calc-addon" value="15000"> E-Commerce Store</label>
                                <label class="checkbox-label"><input type="checkbox" class="calc-addon" value="3000"> Payment Gateway</label>
                                <label class="checkbox-label"><input type="checkbox" class="calc-addon" value="10000"> Custom Dashboard</label>
                                <label class="checkbox-label"><input type="checkbox" class="calc-addon" value="2500"> Logo Design</label>
                                <label class="checkbox-label"><input type="checkbox" class="calc-addon" value="5000"> Premium Content Writing</label>
                                <label class="checkbox-label"><input type="checkbox" class="calc-addon" value="2999"> Monthly Maintenance</label>
                            </div>
                        </div>
                    </div>
                    <div class="calc-result">
                        <h3>Estimated Investment</h3>
                        <div class="calc-price" id="calc-total">₹9,599</div>
                        <p class="calc-note">This is an approximate estimate. Real pricing may vary based on specific bespoke requirements and algorithmic complexity.</p>
                        <a href="https://wa.me/917037311050" id="calc-contact-btn" class="plan-btn" target="_blank" style="margin-top:2rem; width: 100%;">Discuss Your Vision</a>
                    </div>
                </div>
            </section>
            
            <section id="addons" class="fade-in-section">
                <h2 class="section-heading">Custom <em>Add-Ons</em></h2>
                <div class="addons-list">
                    <div class="addon-item"><span>Additional Page</span><span>₹1,000+</span></div>
                    <div class="addon-item"><span>Booking System</span><span>₹5,000+</span></div>
                    <div class="addon-item"><span>E-Commerce Store</span><span>₹15,000+</span></div>
                    <div class="addon-item"><span>Payment Gateway Integration</span><span>₹3,000+</span></div>
                    <div class="addon-item"><span>Custom Dashboard</span><span>₹10,000+</span></div>
                    <div class="addon-item"><span>Logo Design</span><span>₹2,500+</span></div>
                    <div class="addon-item"><span>Monthly Maintenance</span><span>₹2,999+</span></div>
                    <div class="addon-item"><span>Premium Content Writing</span><span>₹5,000+</span></div>
                </div>
            </section>

            <section id="about" class="fade-in-section info-block">
                <h2 class="section-heading">About <em>Us</em></h2>
                <p>Crestiva Web Studio is driven by <strong>Khushwant Singh</strong> and <strong>Sarthak Sengar</strong>. We build immersive digital experiences tailored to your brand, bridging the gap between cutting-edge technology and aesthetic design.</p>
                <p>We believe every website is the digital embodiment of a brand's soul. Let us bring yours to life with algorithmic precision and bespoke craftsmanship.</p>
            </section>

            <section id="contact" class="fade-in-section info-block">
                <h2 class="section-heading">Get in <em>Touch</em></h2>
                <p>Ready to start your project or need a custom quote?</p>
                <p>WhatsApp: <a href="https://wa.me/917037311050" target="_blank">+91 7037311050</a></p>
                <p>Email: <a href="mailto:crestivawebstudio@gmail.com">crestivawebstudio@gmail.com</a></p>
                <br>
                <a href="https://wa.me/917037311050" class="plan-btn" target="_blank">Start the Conversation</a>
            </section>
        </div>
    </div>
    ...
    <script type="module">
        ...
        const material = new THREE.ShaderMaterial({
            uniforms: {
                ...
                uScroll: { value: 0 }, // Scroll uniform for effect
            },
            vertexShader: \`
                ...
                void main() {
                    ...
                    // Scroll effect - expand and swirl
                    float scrollInfluence = uScroll * 1.5;
                    pos *= (1.0 + scrollInfluence * aRandom * 0.5);
                    
                    float swirlRot = uScroll * 3.14 * (0.5 + aRandom * 0.5);
                    float cosS = cos(swirlRot);
                    float sinS = sin(swirlRot);
                    pos.xy = vec2(
                        pos.x * cosS - pos.y * sinS,
                    ...
                    vAlpha *= (1.0 - min(1.0, uScroll * 0.5)); // Fade slightly as you scroll down
                }
            \`,
            fragmentShader: \`
                varying vec3 vColor;
        ...
        window.addEventListener('scroll', () => {
            // we calculate the target scroll in animate for smoothness
        });
        ...
        function animate() {
            ...
            const targetScrollProgress = maxScroll > 0 ? window.scrollY / maxScroll : 0;
            smoothScrollProgress += (targetScrollProgress - smoothScrollProgress) * 0.05;
            material.uniforms.uScroll.value = smoothScrollProgress;
            
            // Camera pushback based on scroll
            camera.position.z = 5 + smoothScrollProgress * 3;
            particles.rotation.z = smoothScrollProgress * Math.PI;
            ...
            particles.rotation.y = elapsed * 0.05 + (smoothScrollProgress * 2);
            particles.position.y = Math.sin(elapsed * 0.3) * 0.05 - (smoothScrollProgress * 1.5);
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const contactBtn = document.getElementById('calc-contact-btn');
            ...
            function updateCalculator() {
                let total = parseInt(calcType.value);
                
                const pages = parseInt(calcPages.value);
                pageCountVal.textContent = pages;
                total += (pages * 1000);
                ...
                // Range simulation for bespoke pricing
                const upperTotal = Math.floor(total * 1.25);
                calcTotal.textContent = formatCurrency(total) + (total > 44000 ? '+' : ' - ' + formatCurrency(upperTotal));

                // Update WhatsApp Message
                const baseText = calcType.options[calcType.selectedIndex].text;
                let msg = \`Hello Crestiva Web Studio! I am interested in a website project. \n\n*Base Plan*: \${baseText} \n*Extra Pages*: \${pages}\`;
                if(selectedAddons.length > 0) {
                    msg += \`\n*Add-ons*: \${selectedAddons.join(', ')}\`;
                }
                msg += \`\n*Estimated Budget*: \${calcTotal.textContent}\`;
                
                contactBtn.href = 'https://wa.me/917037311050?text=' + encodeURIComponent(msg);
            }

            calcType.addEventListener('change', updateCalculator);
            calcPages.addEventListener('input', updateCalculator);
            calcAddons.forEach(a => a.addEventListener('change', updateCalculator));
...
fs.writeFileSync('see-more.html', html, 'utf8');
